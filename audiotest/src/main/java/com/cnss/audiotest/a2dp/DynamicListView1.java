 ...
 */
public class DynamicListView1 extends ListView {
    ...
    public DynamicListView1(Context context) {
        super(context);
        init(context);
    }

    public DynamicListView1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DynamicListView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private Bitmap getBitmapWithBorder(View v) {
        ...
        paint.setColor(Color.parseColor("#ff0277bd"));
